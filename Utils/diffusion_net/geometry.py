...
import Utils.diffusion_net.utils as utils
...
def build_grad2(verts, edges, edge_tangent_vectors):
    """
    ...
    for iV in range(N):
        ...
        lhs_T = lhs_mat.T
        lhs_inv = np.linalg.inv(lhs_T @ lhs_mat + eps_reg * np.identity(f)) @ lhs_T
