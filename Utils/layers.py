...
import Utils.diffusion_net
from Utils.diffusion_net.utils import toNP
from Utils.diffusion_net.geometry import to_basis, from_basis
from torch_geometric.nn import GCNConv
...
class CITRUS_block(nn.Module):
    ...
    def __init__(self, n_block, k, C_in, C_width, C_out, mlp_hidden_dims, num_nodes,
                 ...
                 with_MLP=True,
                 device='cpu'):
        super(CITRUS_block, self).__init__()
    ...
    def forward(self, epoch, x_in, x_original, edge_index, mass, L, evals, evecs, x0):
        ...
        return x0_out      
#%%
class CITRUS_block_v2(nn.Module):
    """
    Inputs and outputs are defined at vertices
    """
    ...
    def __init__(self, n_block, k, C_in, C_width, C_out, mlp_hidden_dims, num_nodes,
                 ...
                 with_MLP=True,
                 device='cpu'):
        super(CITRUS_block_v2, self).__init__()
...
class CITRUS(nn.Module):
    ...
    def __init__(self, k, C_in, C_out, C_width=128, N_block=4, single_t=0, use_gdc=[], num_nodes=[], 
        ...
        self.blocks = []
        for i_block in range(self.N_block):
            block = CITRUS_block(n_block = i_block+1,
                                            k = k,
                                            C_in= C_in,
                                            C_width = C_width, 
                                            C_out=C_out,
