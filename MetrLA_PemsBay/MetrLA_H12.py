...
# from layers import SPINHierarchicalModel
...
logger_CGP_GNN = TensorBoardLogger(save_dir="FINAL_MetrLA_M6_H12", name="FINAL_MetrLA_M6_H12", version=0)

checkpoint_callback_CGPGNN = ModelCheckpoint(
    dirpath='FINAL_MetrLA_M6_H12',
    save_top_k=1,
    monitor='val_mae',
    mode='min',
)
